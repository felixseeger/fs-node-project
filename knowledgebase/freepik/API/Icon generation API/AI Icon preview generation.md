...
````yaml post /v1/ai/text-to-icon/preview
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/text-to-icon/preview:
    post:
      tags:
        - Text to icon
      summary: AI Icon generation
      description: >-
        Create stunning previews icons in different styles and formats (png,
        svg) from text prompts using our advanced AI models.
      operationId: generate_text_to_icon_preview
      requestBody:
        content:
          application/json:
            examples:
              ...
              all-params:
                $ref: '#/components/examples/request-text-to-icon-preview-all'
            schema:
...
components:
  examples:
    ...
    request-text-to-icon-preview-all:
      summary: Request - Text to icon preview all
      value:
        prompt: Sliced avocado and chips
        webhook_url: https://example.com/webhook
        style: color
