...
````yaml get /v1/ai/image-upscaler-precision
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/image-upscaler-precision:
    get:
      tags:
        - upscaler-precision
      summary: Upscaler Precision - List tasks
      description: >-
        Returns a list of all precision upscaler tasks. Each task includes its
        ID, current status, and output URL if completed.
      operationId: getAiImageUpscalerPrecisionTasks
      responses:
        '200':
          content:
            application/json:
