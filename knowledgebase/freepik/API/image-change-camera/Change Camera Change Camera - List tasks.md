...
````yaml get /v1/ai/image-change-camera
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/image-change-camera:
    get:
      tags:
        - image-change-camera
      summary: Change Camera - List tasks
      description: >-
        Retrieve the status of all Change Camera tasks for the authenticated
        user. Returns a list of tasks with their current status, creation time,
        and result URLs for completed tasks.
      operationId: get_all_change_camera_tasks
      responses:
        '200':
          content:
            application/json:
