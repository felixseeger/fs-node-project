...
````yaml get /v1/ai/video/kling-v3-motion-control-pro/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/video/kling-v3-motion-control-pro/{task-id}:
    get:
      tags:
        - video
        - kling-v3-motion-control-pro
      summary: Kling 3 Pro Motion Control - Get task status
      description: >-
        Retrieve the status and result of a specific Kling 3 Pro Motion Control
        video generation task by its task ID.
      operationId: getAiVideoKlingV3MotionControlProTask
      parameters:
