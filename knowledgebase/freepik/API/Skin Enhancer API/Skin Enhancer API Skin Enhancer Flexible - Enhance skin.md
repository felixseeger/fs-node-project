...
````yaml post /v1/ai/skin-enhancer/flexible
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/skin-enhancer/flexible:
    post:
      tags:
        - skin-enhancer
      summary: Skin Enhancer Flexible - Enhance skin
      description: >
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/flexible-request'
        required: true
      responses:
        '200':
          content:
    ...
    flexible-request:
      properties:
        ...
        smart_grain:
          ...
          type: integer
        optimized_for:
          $ref: '#/components/schemas/flexible-optimized-for'
        webhook_url:
          description: >
