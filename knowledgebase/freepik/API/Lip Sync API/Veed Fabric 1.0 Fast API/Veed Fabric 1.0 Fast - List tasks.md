...
````yaml get /v1/ai/lip-sync/veed-fabric-1-0-fast
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/lip-sync/veed-fabric-1-0-fast:
    get:
      tags:
        - lip-sync
      summary: Veed Fabric 1.0 Fast - List tasks
      description: >-
        Retrieve all Veed Fabric 1.0 Fast lip-sync tasks for the authenticated
        user.
      operationId: get_all_veed_fabric_1_0_fast_tasks
      responses:
        '200':
          content:
            application/json:
          ...
          description: OK - List of Veed Fabric 1.0 Fast tasks
        '400':
          content:
            application/json:
              examples:
