...
paths:
  /v1/ai/loras/styles:
    post:
      tags:
        - loras
      summary: Mystic LoRA Styles - Train custom style
      description: >
        Create you own custom style using LoRAs training
      ...
      requestBody:
        content:
          application/json:
            examples:
              characters-request:
                $ref: '#/components/examples/request-loras-styles'
            schema:
              $ref: '#/components/schemas/loras-style-request'
      responses:
        '200':
          content:
            application/json:
          ...
          description: OK - The request has succeeded and the style is processing
        '400':
          content:
            application/json:
              examples:
...
components:
  examples:
    request-loras-styles:
      summary: Request - LoRAs styles training
      value:
  ...
  schemas:
    loras-style-request:
      properties:
        name:
          description: >-
            Name of the LoRA style. This name will be used to identify the style
            in the system.
          pattern: ^[a-zA-Z0-9-_]+$
          type: string
        description:
        ...
        quality:
          ...
          type: string
        images:
          description: List of images to train the LoRA style
          items:
            description: Url of the image to train the LoRA style
            format: uri
            type: string
          maxItems: 20
          minItems: 6
