...
````yaml get /v1/ai/text-to-image/flux-kontext-pro
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/text-to-image/flux-kontext-pro:
    get:
      tags:
        - text-to-image
      summary: Flux Kontext Pro - List tasks
      description: >-
        Retrieve the status of all Flux Kontext Pro text-to-image generation
        tasks for the authenticated user.
      operationId: get_all_flux_kontext_pro_tasks
      responses:
        '200':
          content:
            application/json:
          ...
          description: OK - Successfully retrieved all Flux Kontext Pro tasks
        '400':
          content:
            application/json:
              examples:
