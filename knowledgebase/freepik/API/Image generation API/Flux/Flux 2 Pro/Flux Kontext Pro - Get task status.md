...
````yaml get /v1/ai/text-to-image/flux-kontext-pro/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/text-to-image/flux-kontext-pro/{task-id}:
    get:
      tags:
        - text-to-image
      summary: Flux Kontext Pro - Get task status
      description: >-
        Retrieve the status and results of a specific Flux Kontext Pro
        text-to-image generation task.
      operationId: get_flux_kontext_pro_task
      parameters:
