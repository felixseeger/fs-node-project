...
````yaml GET /v1/ai/text-to-image/flux-2-klein
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/text-to-image/flux-2-klein:
    get:
      tags:
        - text-to-image
      summary: Flux 2 Klein - List tasks
      description: >-
        Retrieve the status of all FLUX.2 [klein] text-to-image generation tasks
        for the authenticated user.
      operationId: get_all_flux_2_klein_tasks
      responses:
        '200':
          content:
            application/json:
          ...
          description: OK - Successfully retrieved all Flux 2 Klein tasks
        '400':
          content:
            application/json:
              examples:
