...
````yaml GET /v1/ai/text-to-image/flux-2-klein/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/text-to-image/flux-2-klein/{task-id}:
    get:
      tags:
        - text-to-image
      summary: Flux 2 Klein - Get task status
      description: >-
        Retrieve the status and results of a specific FLUX.2 [klein] generation
        task.
      operationId: get_flux_2_klein_task
      parameters:
