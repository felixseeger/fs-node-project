...
paths:
  /v1/ai/text-to-image/hyperflux:
    post:
      tags:
        - text-to-image
      summary: HyperFlux - Create image from text
      description: >
        This endpoint allows you to generate an image using the HyperFlux model,
        the fastest Flux model available
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/request-content_1'
        required: true
      responses:
        '200':
          content:
  ...
  schemas:
    request-content_1:
      properties:
        ...
        seed:
          description: >-
            Seed for the image generation. If not provided, a random seed will
            be used.
          maximum: 4294967295
          minimum: 1
          type: integer
