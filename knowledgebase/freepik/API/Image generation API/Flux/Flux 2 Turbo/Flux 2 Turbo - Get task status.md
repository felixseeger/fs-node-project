...
````yaml get /v1/ai/text-to-image/flux-2-turbo/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/text-to-image/flux-2-turbo/{task-id}:
    get:
      tags:
        - text-to-image
      summary: Flux 2 Turbo - Get task status
      description: >-
        Retrieve the status and results of a specific Flux 2 Turbo generation
        task.
      operationId: get_flux_2_turbo_task
      parameters:
