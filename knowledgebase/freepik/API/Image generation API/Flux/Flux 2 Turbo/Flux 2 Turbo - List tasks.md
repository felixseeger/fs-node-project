...
````yaml get /v1/ai/text-to-image/flux-2-turbo
openapi: 3.0.0
info:
  description: >-
...
paths:
  /v1/ai/text-to-image/flux-2-turbo:
    get:
      tags:
        - text-to-image
      summary: Flux 2 Turbo - List tasks
      description: >-
        Retrieve the status of all Flux 2 Turbo text-to-image generation tasks
        for the authenticated user.
      operationId: get_all_flux_2_turbo_tasks
      responses:
        '200':
          content:
            application/json:
          ...
          description: OK - Successfully retrieved all Flux 2 Turbo tasks
        '400':
          content:
            application/json:
              examples:
