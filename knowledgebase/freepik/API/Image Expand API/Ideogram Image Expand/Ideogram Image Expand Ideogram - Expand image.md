...
````yaml post /v1/ai/image-expand/ideogram
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/image-expand/ideogram:
    post:
      tags:
        - image-expand
      summary: Ideogram - Expand image
      description: >
        This endpoint allows you to expand an image using the Ideogram AI model.
        The image will be expanded based on the provided pixel values for each
        side.
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/image-expand-ideogram-request'
        required: true
      responses:
        '200':
          content:
