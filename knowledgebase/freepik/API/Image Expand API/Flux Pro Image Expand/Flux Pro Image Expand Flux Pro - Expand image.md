...
security:
  - apiKey: []
paths:
  /v1/ai/image-expand/flux-pro:
    post:
      tags:
        - image-expand
      summary: Flux Pro - Expand image
      description: >
        This endpoint allows you to expand an image using the AI Flux Pro model.
        The image will be expanded based on the provided parameters.
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/image-expand-request'
        required: true
      responses:
        '200':
          content:
