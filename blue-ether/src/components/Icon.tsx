...
export type IconName =
  ...
  // Map / Location (Requested by user "map app")
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  'aspect-ratio': <><rect x="3" y="5" width="18" height="14" rx="2" ry="2" /><path d="M7 15v-4h4" /><path d="M17 9v4h-4" /></>,
  'resolution': <><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></>, // Box with resize arrows usually, simplifying
  ...
  'workflow': <><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><path d="M3 9h18" /><path d="M9 21V9" /><path d="M15 21V9" /><path d="M9 3l0 18" /><path d="M15 3l0 18" /></>,
  ...
  'generate': <><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" /></>,
  ...
  'profile': <><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><circle cx="12" cy="10" r="3" /><path d="M7 21v-2a4 4 0 0 1 4-4h2a4 4 0 0 1 4 4v2" /></>,
  'discord': <><path d="M15.22 4.14c-1.28-.59-2.66-1.02-4.1-1.24-.18.32-.38.75-.52 1.09-1.51-.23-3-.23-4.48 0-.15-.34-.34-.77-.52-1.09-1.44.22-2.82.65-4.1 1.24C-1.56 12.38-.25 20.35 2.76 22c1.35-1 2.65-1.6 3.9-2.01-.33-.42-.62-.87-.88-1.34-1.32.5-2.6.99-3.82 1.54.12-.1.24-.2.36-.3 2.58-1.78 5.4-2.85 8.48-2.85s5.9 1.07 8.48 2.85c.12.1.24.2.36.3-1.22-.55-2.5-1.04-3.82-1.54-.26.47-.55.92-.88 1.34 1.25.41 2.55 1.01 3.9 2.01 3.13-1.73 4.41-9.72 1.26-17.86zm-8.2 12.37c-.98 0-1.78-.92-1.78-2.05s.78-2.05 1.78-2.05c1 0 1.8.93 1.78 2.05 0 1.13-.8 2.05-1.78 2.05zm7.16 0c-.98 0-1.78-.92-1.78-2.05s.78-2.05 1.78-2.05c1 0 1.8.93 1.78 2.05 0 1.13-.78 2.05-1.78 2.05z" /></>,
  ...
  'disconnect': <><path d="m18.84 12.25 1.72-1.71h-.02a5.004 5.004 0 0 0-7.07-7.07l-4.57 4.57 1.41 1.41" /><path d="m5.17 11.75-1.71 1.71a5.004 5.004 0 0 0 7.07 7.07l4.57-4.57-1.41-1.41" /><line x1="15.18" y1="8.82" x2="8.82" y2="15.18" /></>,
};

export const Icon: React.FC<IconProps> = ({ name, size = 24, crt = true, className, style, ...props }) => {
  ...
  return (
    <svg
      ...
      className={`be-icon be-icon-${name} ${className || ''}`}
      style={{
        display: 'inline-block',
        verticalAlign: 'middle',
        ...(crt ? { filter: 'drop-shadow(-2px 0px 1px var(--pink)) drop-shadow(2px 0px 1px var(--darker-cyan))' } : {}),
        ...style,
      }}
      {...props}
    >
