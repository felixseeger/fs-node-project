    ...
    >
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <input type="range" min={10} max={240} step={1} value={localDuration}
              onChange={(e) => update({ localDuration: Number(e.target.value) })}
              style={{ flex: 1, accentColor: ACCENT }} />
            <span style={{ fontSize: 9, color: '#555', minWidth: 14 }}>240</span>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 600, color: '#e0e0e0' }}>Generated Music</span>
        </div>
      ...
      <div style={{
        ...
        {isActive ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 10, color: '#999' }}>Composing music...</span>
          </div>
        ) : data.outputAudio ? (
