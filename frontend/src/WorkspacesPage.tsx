...
// New Workspace Modal (two-step)
interface NewWorkspaceModalProps {
  onClose: () => void;
  onSelect: (type: string, aiPrompt?: string, aiMode?: string) => void;
}

const NewWorkspaceModal: FC<NewWorkspaceModalProps> = ({ onClose, onSelect }) => {
      ...
      >
        ...
        >
          ...
          <p style={{
            ...
            Describe what you want your workspace to do and{' '}
            <span style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: '#888', lineHeight: 1.4 }}>
              Describe what you want and <span style={{
                display: 'inline-block', background: '#1a1a1a', border: '1px solid #333',
                borderRadius: 4, padding: '1px 6px', fontSize: 11, fontWeight: 600, color: '#ccc',
              }}>AI</span> will build the workspace
            </div>
          </div>
        </button>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: '#777', lineHeight: 1.4 }}>
                Start from a pre-built workspace and customize it
              </div>
            </div>
          </button>
        </div>
...
interface WorkspacesPageProps {
  onCreateWorkspace: (name: string, id?: string) => void;
  workspaces?: Workspace[];
}

export const WorkspacesPage: FC<WorkspacesPageProps> = ({ onCreateWorkspace, workspaces = [] }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '60px 40px' }}>
        ...
        {/* Introducing Workspaces section */}
        <div style={{ marginTop: 56, marginBottom: 60 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <p style={{
              ...
              Build powerful AI image pipelines with a visual editor. Connect nodes, configure models, and deploy — all without writing backend code.
            </p>
          </div>
          ...
          <div style={{
            ...
            >
              ...
              <p style={{ fontSize: 12, color: '#888', lineHeight: 1.5, margin: 0 }}>
                Start from ready-made workspaces for common image tasks. Customize and ship in minutes.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: 12, color: '#888', lineHeight: 1.5, margin: 0 }}>
                Deploy any workspace as a live API endpoint instantly. Integrate with any app via SDK.
              </p>
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ paddingLeft: 16 }}><span style={{ color: '#22c55e' }}>workspace</span>: <span style={{ color: '#f97316' }}>'img-pipeline'</span>,</div>
              ...
              <div style={{ fontSize: 16, fontWeight: 700, color: '#e0e0e0', marginBottom: 8 }}>
                API-First Workspaces
              </div>
              <p style={{ fontSize: 13, color: '#888', lineHeight: 1.55, margin: 0 }}>
                Every workspace is an API endpoint. Deploy in one click and integrate into any app with our SDK.
              </p>
            </div>
            ...
            >
              ...
              <div style={{
                ...
                <div><span style={{ color: '#666' }}>$</span> <span style={{ color: '#22c55e' }}>npx</span> <span style={{ color: '#e0e0e0' }}>kora</span> code-workspace</div>
              ...
              <p style={{ fontSize: 13, color: '#888', lineHeight: 1.55, margin: 0 }}>
                Manage, test, and deploy workspaces from the terminal. CI/CD ready with environment variables.
              </p>
            </div>
          </div>
        </div>
