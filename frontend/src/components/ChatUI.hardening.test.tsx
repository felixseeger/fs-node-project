...
describe('ChatUI Hardening', () => {
  ...
  it('handles invalid image type upload', async () => {
    ...
    const input = screen.getByLabelText(/Attach context image/i).parentElement?.querySelector('input[type="file"]') as HTMLInputElement;
    
    // Bypass accept attribute for testing
