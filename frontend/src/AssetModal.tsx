...
interface AssetModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpload?: (type: string, data: Record<string, unknown>) => void;
}

export default function AssetModal({ isOpen, onClose, onUpload }: AssetModalProps): React.ReactElement | null {
