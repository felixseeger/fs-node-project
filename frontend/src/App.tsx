...
const handleConnectEnd = useCallback(
  ...
  const resolveInput = useCallback((nodeId: string, handleId: string, originalHandleId = handleId) => {
    ...
    if (dataType === 'image' || dataType === 'video' || dataType === 'audio') return results;
