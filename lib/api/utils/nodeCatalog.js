...
export const NODE_CATALOG = [
  // Inputs
  { type: 'textNode', label: 'Prompt', category: 'input', keywords: ['text', 'prompt', 'input', 'description', 'write', 'content'] },
  { type: 'imageNode', label: 'Image', category: 'input', keywords: ['image', 'photo', 'picture', 'upload', 'visual', 'source'] },
  { type: 'imageElement', label: 'Image Element', category: 'input', keywords: ['image', 'placeholder', 'asset', 'graphic'] },
  { type: 'assetNode', label: 'Asset', category: 'input', keywords: ['asset', 'collection', 'batch', 'multiple', 'group'] },
  { type: 'sourceMediaNode', label: 'Source Media Upload', category: 'input', keywords: ['upload', 'video', 'audio', 'file', 'source'] },
  { type: 'voiceInputNode', label: 'Voice Input', category: 'input', keywords: ['voice', 'speech', 'record', 'microphone', 'input'] },
  ...
  { type: 'imageToPrompt', label: 'Image to Prompt', category: 'llm', keywords: ['reverse', 'prompt from image', 'describe image', 'caption', 'interrogate'] },
  { type: 'improvePrompt', label: 'Improve Prompt', category: 'llm', keywords: ['enhance', 'improve', 'better prompt', 'refine', 'optimize'] },
  { type: 'adaptedPrompt', label: 'Adapted Prompt', category: 'llm', keywords: ['transform', 'prompt', 'context', 'adapt'] },
  ...
  { type: 'universalGeneratorImage', label: 'Universal Image', category: 'image-gen', keywords: ['generate', 'image', 'multi-model', 'flux', 'mystic', 'quality'] },
  { type: 'tripo3d', label: 'Tripo3D', category: 'image-gen', keywords: ['3d', 'model', 'mesh', 'generate', 'tripo', 'object'] },
  { type: 'textToIcon', label: 'AI Icon Generation', category: 'image-gen', keywords: ['icon', 'logo', 'symbol', 'svg', 'app icon', 'generate'] },
  { type: 'fluxReimagine', label: 'Flux Reimagine', category: 'image-gen', keywords: ['flux', 'reimagine', 'variation', 'alternative', 'remix'] },
  { type: 'recraftGenerate', label: 'Recraft Image', category: 'image-gen', keywords: ['recraft', 'generate', 'vector-style', 'clean', 'illustration'] },
  ...
  { type: 'imageSegmentation', label: 'Image Segmentation', category: 'image-edit', keywords: ['segment', 'sam', 'mask', 'isolate', 'object detection'] },
  { type: 'quiverImageToVector', label: 'Quiver Image to Vector', category: 'image-edit', keywords: ['vector', 'svg', 'quiver', 'trace', 'vectorize'] },
  ...
  { type: 'recraftVectorize', label: 'Recraft Vectorize', category: 'image-edit', keywords: ['vector', 'svg', 'recraft', 'trace'] },
  { type: 'recraftUpscale', label: 'Recraft Upscale', category: 'image-edit', keywords: ['upscale', 'recraft', 'enhance'] },

  // Video Generation
  { type: 'universalGeneratorVideo', label: 'Universal Video', category: 'video-gen', keywords: ['video', 'generate', 'multi-model', 'kling', 'runway', 'quality'] },
  ...
  { type: 'ltxVideo', label: 'LTX Video AI', category: 'video-gen', keywords: ['video', 'ltx', 'video generation', 'ai video'] },
  ...
  { type: 'lumaGenerate', label: 'Luma Dream Machine', category: 'video-gen', keywords: ['luma', 'dream machine', 'video', 'ray', 'photon'] },

  // Video Editing
  { type: 'layerEditor', label: 'Layer Editor', category: 'video-edit', keywords: ['layer', 'composite', 'combine', 'merge', 'blend', 'timeline', 'nle'] },
  { type: 'corridorKey', label: 'CorridorKey AI', category: 'video-edit', keywords: ['vfx', 'keying', 'green-screen', 'background', 'isolate'] },
  { type: 'vfx', label: 'Video FX', category: 'video-edit', keywords: ['vfx', 'effect', 'filter', 'video effect', 'bloom', 'motion'] },
  { type: 'creativeVideoUpscale', label: 'Creative Video Upscale', category: 'video-edit', keywords: ['video upscale', 'enhance video', 'video quality', 'creative'] },
  ...
  { type: 'videoImprove', label: 'Video Improve', category: 'video-edit', keywords: ['improve', 'enhance', 'fix', 'video', 'upscale'] },

  // Audio Generation
  { type: 'universalGeneratorAudio', label: 'Universal Audio', category: 'audio', keywords: ['audio', 'music', 'sound', 'generate', 'multi-model'] },
  ...
  { type: 'soundEffects', label: 'ElevenLabs Sound Effects', category: 'audio', keywords: ['sound', 'sfx', 'effect', 'audio effect', 'elevenlabs'] },
  { type: 'audioIsolation', label: 'SAM Audio Isolation', category: 'audio', keywords: ['isolate', 'remove vocals', 'extract audio', 'stems', 'vocal remover'] },
  { type: 'pixVerseSoundEffect', label: 'PixVerse Sound Effect', category: 'audio', keywords: ['sfx', 'video-to-audio', 'pixverse', 'sound effects'] },
  { type: 'voiceover', label: 'ElevenLabs Voiceover', category: 'audio', keywords: ['voice', 'narration', 'tts', 'text to speech', 'voiceover'] },

  // Logic & Flow
  { type: 'condition', label: 'Condition', category: 'logic', keywords: ['if', 'then', 'else', 'branch', 'logic', 'gate'] },
  { type: 'iteration', label: 'Iteration', category: 'logic', keywords: ['loop', 'repeat', 'for', 'each', 'cycle'] },
  { type: 'variable', label: 'Variable', category: 'logic', keywords: ['set', 'get', 'store', 'data', 'parameter'] },

  // Social & Integrations
  { type: 'socialPublisher', label: 'Social Publisher', category: 'integrations', keywords: ['publish', 'share', 'social', 'x', 'twitter', 'instagram', 'tiktok'] },
  { type: 'cloudSync', label: 'Cloud Sync', category: 'integrations', keywords: ['sync', 'cloud', 'backup', 'drive', 's3', 'dropbox', 'storage'] },

  // Utilities
  { type: 'routerNode', label: 'Router', category: 'utility', keywords: ['route', 'branch', 'split', 'distribute', 'fan out', 'hub'] },
  { type: 'comment', label: 'Comment', category: 'utility', keywords: ['comment', 'note', 'annotation', 'label', 'sticky'] },
  { type: 'workflowNode', label: 'Workflow', category: 'utility', keywords: ['sub-workflow', 'nested', 'reusable', 'component'] },
  { type: 'outputNode', label: 'Output', category: 'utility', keywords: ['export', 'result', 'save', 'final'] },
];
