...
const sanitizerCode = `
// Helper to sanitize payload for BullMQ (removes functions/streams, converts Buffers to base64)
function sanitizePayload(obj) {
  if (obj === null || obj === undefined) return obj;
  if (Buffer.isBuffer(obj)) {
    return \`data:application/octet-stream;base64,\${obj.toString('base64')}\`;
  }
  // Check if it's already a serialized buffer object
  ...
  if (typeof obj === 'function' || (obj.pipe && typeof obj.pipe === 'function')) {
    return undefined; // Drop functions and streams
  }
