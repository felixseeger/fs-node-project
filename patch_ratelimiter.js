...
const p = 'lib/api/middleware/rateLimiter.js';
let code = fs.readFileSync(p, 'utf8');

// Remove previously appended block if present
code = code.replace(/\/\/ Daily generation limit[\s\S]*?\n}\);\n/m, '');

// Re-write it correctly
const newCode = `import rateLimit from 'express-rate-limit';
